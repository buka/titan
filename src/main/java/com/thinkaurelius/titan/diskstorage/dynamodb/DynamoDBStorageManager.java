...
public class DynamoDBStorageManager implements StorageManager {
  ...
  private static final Logger _logger = LoggerFactory.getLogger(DynamoDBStorageManager.class);
  ...
  public DynamoDBStorageManager(org.apache.commons.configuration.Configuration config) {
  ...
  public OrderedKeyColumnValueStore openDatabase(String name)
    ...
    OrderedKeyColumnValueStore lockStore = _openDatabase(name + "_locks", null, null);
